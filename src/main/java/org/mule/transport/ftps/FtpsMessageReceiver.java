...
public class FtpsMessageReceiver extends AbstractPollingMessageReceiver
{
    ...
    public FtpsMessageReceiver(Connector connector,
                              ...
                              long frequency) throws CreateException
    {
        ...
        this.connector = (FtpsConnector) connector;
    ...
    private final class FtpWork implements Work
    {
        ...
        public void run()
        {
            ...
            if (lock.tryLock())
            {
                ...
                {
                    client = connector.createFTPSClient(endpoint);
                    final FTPSClient finalClient = client;
                    currentFiles.add(name);
                    if (!connector.validateFile(file))
                    {
                        return;
                    }
                    FtpsMuleMessageFactory muleMessageFactory = createMuleMessageFactory(finalClient);
